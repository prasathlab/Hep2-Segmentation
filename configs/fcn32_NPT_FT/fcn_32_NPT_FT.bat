...
res_dir=/data/aronow/Balaji_Iyer/Projects/Hep-2_Segmentation/Results/Trial_Runs
code_dir=/data/aronow/Balaji_Iyer/Projects/Hep-2_Segmentation/Hep2-Segmentation

yaml_path="/data/aronow/Balaji_Iyer/Projects/Hep-2_Segmentation/Hep2-Segmentation/configs/fcn32_NPT_FT/fcn_32_NPT_FT.yaml"
