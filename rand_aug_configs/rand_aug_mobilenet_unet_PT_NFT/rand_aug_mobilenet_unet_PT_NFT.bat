...
yaml_path="/data/aronow/Balaji_Iyer/Projects/Hep-2_Segmentation/Hep2-Segmentation/rand_aug_configs/rand_aug_mobilenet_unet_PT_NFT/rand_aug_mobilenet_unet_PT_NFT.yaml"

#First call the train model script
cd ${code_dir}

weights_path="/data/aronow/Balaji_Iyer/Projects/Hep-2_Segmentation/Results/New_Models/mobilenet_unet_PT_NFT_2021-09-12_00-26-54/Models/Final_Model/best_model.hdf5"
