...
yaml_path="/data/aronow/Balaji_Iyer/Projects/Hep-2_Segmentation/Hep2-Segmentation/GAN_configs/resnet50_unet_NPT_FT_patchGAN/resnet50_unet_NPT_FT_patchGAN.yaml"
